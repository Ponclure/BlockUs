...
## Title/sound
title @a title ["",{"text":"≈"},{"text":"Emergency Meeting","color":"red"}]
title @a subtitle {"text":"Discuss!","color":"none"}
execute as @a at @s run playsound minecraft:e_meeting master @s ~ ~ ~ 9999
...
## Scores
scoreboard players add e_meetings game_track 1
scoreboard players set e_meeting_cd game_track -1
