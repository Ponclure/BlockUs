...
public class ConfigBase implements Config {
    ...
    protected final BukkitScheduler scheduler = pluginInstance.getServer().getScheduler();
    protected final FileConfiguration configuration;
    protected final File file;

    ConfigBase(File file,
    ...
    @Override
    public <T extends ConfigurationSerializable> T getSerializable(String path,
                                                                   Class<T> type) {
