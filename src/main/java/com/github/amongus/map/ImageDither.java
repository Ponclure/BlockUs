...
/**
 * What a piece of optimization; Performs incredibly fast Minecraft color
 * conversion and dithering.
 * 
 * @author jetp250
 */

public final class ImageDither {
...
//	}
	...
	static {
		...
		PALETTE = colors.stream().mapToInt(i -> i).toArray();
...
class LoadBlue extends RecursiveTask<Byte> {
	...
	protected Byte compute() {
		...
		for (int i = 4; i < palette.length; ++i) {
			...
			distance = weight_red * redVal * redVal + weight_green * greenVal * greenVal
